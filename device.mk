...
PRODUCT_COPY_FILES := \
    ...
    $(LOCAL_PATH)/rootdir/init.renderer.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.renderer.sh
...
# headset keylayout
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/keylayout/h2w_headset.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/h2w_headset.kl
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/permissions/privapp-permissions-flounder.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/privapp-permissions-flounder.xml
...
PRODUCT_PACKAGES += \
    ...
    android.hardware.health@2.0-service.flounder
